...
// imagens
import imgTeam2 from './../assets/img/team-2-800x800.jpg'
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faBriefcase, faMapMarkedAlt, faMapMarker, faMapMarkerAlt, faUniversity } from "@fortawesome/free-solid-svg-icons";
              ...
              <div className="px-6">
                ...
                <div className="text-center mt-12">
                  ...
                  <div className="text-sm leading-normal mt-0 mb-2 text-slate-400 font-bold uppercase">
                    <FontAwesomeIcon icon={faMapMarkerAlt} className="mr-2 text-lg text-slate-400" />{" "}
                    Los Angeles, California
                  </div>
                  <div className="mb-2 text-slate-600 mt-10">
                    <FontAwesomeIcon icon={faBriefcase} className="mr-2 text-lg text-slate-400" />
                    Solution Manager - Creative Tim Officer
                  </div>
                  <div className="mb-2 text-slate-600">
                    <FontAwesomeIcon icon={faUniversity} className="mr-2 text-lg text-slate-400" />
