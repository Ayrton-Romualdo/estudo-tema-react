...
import imgGitHubSvg from "./../../assets/img/github.svg"
import imgGoogleSvg from "./../../assets/img/google.svg"
      ...
      <div className="container mx-auto px-4 h-full">
        <div className=" flex content-center items-center justify-center h-full">
          <div className="w-full lg:w-4/12 px-4">
            <div className="bg-gray-50  relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-slate-200 border-0">
