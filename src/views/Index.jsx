...
// imagens
import imgPatterReact from "./../../src/assets/img/pattern_react.png"
import imgComponentBtn from "./../../src/assets/img/component-btn.png"
import imgComponentProfileCard from "./../../src/assets/img/component-profile-card.png"
import imgComponentInfoCard from "./../../src/assets/img/component-info-card.png"
import imgComponentInfo2 from "./../../src/assets/img/component-info-2.png"
import imgComponentMenu from "./../../src/assets/img/component-menu.png"
import imgComponenBtnPink from "./../../src/assets/img/component-btn-pink.png"
import imgDocumentation from "./../../src/assets/img/documentation.png"
import imgLogin from "./../../src/assets/img/login.jpg"
import imgProfile from "./../../src/assets/img/profile.jpg"
import imgLanding from "./../../src/assets/img/landing.jpg"


import IndexNavbar from "./../components/Navbars/IndexNavbar.jsx";
import Footer from "./../components/Footers/Footer.jsx";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faAngleDoubleRight, faCode, faCodeBranch, faCodeCompare, faCompassDrafting, faDraftingCompass, faFileAlt, faFingerprint, faNewspaper, faPaperPlane, faSitemap } from "@fortawesome/free-solid-svg-icons";
          ...
          <div className="w-full md:w-8/12 lg:w-6/12 xl:w-6/12 px-4">
            <div className="pt-32 sm:pt-0">
              ...
              <div className="mt-12">
                ...
                <a
                  href="#"
                  className=" ml-1 text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-gray-700 active:bg-gray-600 uppercase text-sm shadow hover:shadow-lg ease-linear transition-all duration-150"
                  target="_blank"
                >
                  Github Star
                </a>
              ...
              <div className="flex flex-wrap">
                <div className="w-full md:w-6/12 px-4">
                  ...
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      <div className="text-slate-500 p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-white">
                        <FontAwesomeIcon icon={faCompassDrafting} className="text-xl" />
                      </div>
                      <h6 className="text-xl mb-1 font-semibold">
          ...
          <div className="flex flex-wrap items-center">
            ...
            <div className="w-full md:w-5/12 px-4 mr-auto ml-auto mt-32">
              <div className="relative flex flex-col min-w-0 w-full mb-6 mt-48 md:mt-0">
                ...
                <img
                  alt="..."
                  src={imgComponentProfileCard}
                  className="w-full align-middle rounded-lg absolute shadow-lg -top-160-px left-260-px max-w-210-px"
                />
                <img
                  alt="..."
                  src={imgComponentInfoCard}
                  className="w-full align-middle rounded-lg absolute shadow-lg max-w-180-px -top-225-px left-40-px z-2"
                />
                <img
                  alt="..."
                  src={imgComponentInfo2}
                  className="w-full align-middle rounded-lg absolute shadow-2xl max-w-200-px -left-50-px top-25-px"
                />
                <img
                  alt="..."
                  src={imgComponentMenu}
                  className="w-full align-middle rounded absolute shadow-lg max-w-580-px -left-20-px top-210-px"
                />
                <img
                  alt="..."
                  src={imgComponenBtnPink}
          ...
          <div className="items-center flex flex-wrap">
            <div className="w-full md:w-5/12 ml-auto px-12 md:px-4">
              <div className="md:pr-12">
                <div className="text-slate-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                  <FontAwesomeIcon icon={faFileAlt} className="ml-1" />
                </div>
        ...
        <div className="container mx-auto pb-64">
          <div className="flex flex-wrap justify-center">
            ...
            <div className="w-full md:w-4/12 px-4 mr-auto ml-auto mt-32 relative">
              <FontAwesomeIcon icon={faCodeCompare}  className="text-slate-700 absolute -top-150-px -right-100 left-auto opacity-80 text-55"/>
            </div>
          </div>
        </div>
      </section>
            ...
            <div className="w-full text-center lg:w-8/12">
              ...
              <div className="sm:block flex flex-col mt-10">
                ...
                <a
                  href="#"
                  target="_blank"
                  className="sm:ml-1 text-white font-bold px-6 py-4 rounded outline-none focus:outline-none mr-1 mb-1 bg-slate-700 active:bg-slate-600 uppercase text-sm shadow hover:shadow-lg"
                >
                  <FontAwesomeIcon icon={faCodeBranch} className="text-lg mr-1" />
