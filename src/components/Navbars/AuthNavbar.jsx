          ...
          >
            <ul className="flex flex-col lg:flex-row list-none mr-auto">
              <li className="flex items-center">
                ...
                >
                  <FontAwesomeIcon icon={faFileAlt} className="lg:text-slate-200 text-slate-400 text-lg leading-lg mr-2" />{" "}
                  Docs
                </a>
              </li>
            </ul>
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <FontAwesomeIcon icon={faFacebook} className="lg:text-slate-200 text-slate-400 text-lg leading-lg" />
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <FontAwesomeIcon icon={faTwitter} className="lg:text-slate-200 text-slate-400 text-lg leading-lg" />
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <FontAwesomeIcon icon={faGithub} className="lg:text-slate-200 text-slate-400 text-lg leading-lg" />
