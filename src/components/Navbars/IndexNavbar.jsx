      ...
      <nav className="top-0 fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-white shadow">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            ...
            <button
              className="cursor-pointer text-xl leading-none px-3 py-1 border border-solid border-transparent rounded bg-blue-300 block lg:hidden outline-none focus:outline-none"
              type="button"
          ...
          >
            <ul className="flex flex-col lg:flex-row list-none mr-auto">
              <li className="flex items-center">
                ...
                >
                  <FontAwesomeIcon icon={faFileAlt} className="text-slate-400 text-lg leading-lg mr-2" />{" "}
                  Docs
                </a>
              </li>
            </ul>
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <FontAwesomeIcon icon={faFacebook} className="text-slate-400 text-lg leading-lg" />
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <FontAwesomeIcon icon={faTwitter} className="text-slate-400 text-lg leading-lg" />
              ...
              <li className="flex items-center">
                <a
                  ...
                  target="_blank"
                >
                  <FontAwesomeIcon icon={faGithub} className="text-slate-400 text-lg leading-lg" />
